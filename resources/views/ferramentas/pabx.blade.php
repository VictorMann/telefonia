    ...
    <div class="row mb-2">
        ...
        <div class="col-md">
            ...
            <form class="form-inline">
                ...
                <input name="exibir" id="pesquisar" class="form-control form-control-sm" placeholder="Buscar PABX?">
            </form>
        ...
        <div class="col-md">
            <table class="tb-base table table-sm table-striped">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>COMPARTILHADO-6</td>
                        <td>http://pabx6.twsolutions.com.br/api/v1</td>
