    ...
    <div class="row mb-2">
        ...
        <div class="col-md">
            ...
            <form class="form-inline">
                ...
                <input name="exibir" id="pesquisar" class="form-control form-control-sm" placeholder="Buscar departamento?">
            </form>
    ...
    <div class="row">
        <div class="col-md">
            <table class="tb-base table table-sm table-striped">
                <thead>
                    <tr>
                        <th class="pt-2 pb-2">Departamento</th>
                        <th class="pt-2 pb-2">Responsável</th>
                ...
                <tbody>
                    <tr>
                        <td>Comercial</td>
                        <td>Rafael Costa</td>
                        <td>contato@twsolutions.com.br</td>
