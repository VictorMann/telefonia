    ...
    <div class="row mb-2">
        ...
        <div class="col-md">
            ...
            <form class="form-inline">
                ...
                <input name="exibir" id="pesquisar" class="form-control form-control-sm" placeholder="Buscar tipo?">
            </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-unstyled d-flex lista-acao">
                                <li>
                                    <a href="#" data-toggle="popover" data-content="Editar tipo">
