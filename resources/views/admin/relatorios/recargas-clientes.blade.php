...
@section('content')
    ...
    <div class="title-page">
        <h1>Relatório de Gestão de Recargas</h1>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm">
                            <option value="">Pedro Coelho</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm">
                            <option value="">Crédito de Mensalidade</option>
                            <option value="">Recarga de Crédito</option>
                        </select>
                    </div>
                </div>
    ...
    <table class="tb-base table table-sm table-striped">
        <thead>
            <tr>
                ...
                <th class="pt-2 pb-2">Vlr. Recarga</th>
                <th class="pt-2 pb-2">Dt. Recarga</th>
                <th class="pt-2 pb-2">Validade</th>
                <th class="pt-2 pb-2">Tipo</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>Jandir G. Souza</td>
                <td>R$ 130,00</td>
                <td>05/06/2019</td>
                <td>02/12/2019</td>
                <td>Crédito de mensalidade</td>
            </tr>
        </tbody>
    </table>
